...
/** Constructor AccountController builds the controller * @param r - the input-view object * @param w - the output-view object * @param a - the model object */
...
/** processTransactions processes user commands until a Q is entered */
 public void processTransactions()
  { char command = reader.readCommand("Command (D,W,Q) and add after space amount:");
    if ( command == 'Q' ) // quit? 
       { } // terminate method by doing nothing more 
        ...
        if ( ok ) { writer.showTransaction("Withdrawal of $", amount); } 
