import javax.swing.*; /** BankReader reads bank transactions from the user */ 
...
public BankReader() { input_line = ""; }
/** readCommand reads a new command line * @param message - the prompt to the user * @return the first character of the command */ 
...
/** readAmount returns the numerical value included in the input command line * @return the amount, converted entirely into cents;
 if there is * no amount to return, announce an error and return 0. */
 public int readAmount()
  { int answer = 0; // extract substring of input line that forgets the initial character: 
